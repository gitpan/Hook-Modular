...
L<Hook::Modular> configurations. The following functions are exported
automatically:
...
This package is also a class in disguise. The following methods are not
intended for public consumption, but they are documented nevertheless.
